...
def processing_parenthesis_and_calculate(remaining_operands,remaining_operators):
    ...
    for index in range(len(processed_operators)):
        result=calculate(result,processed_operands[index+1],processed_operators[index])
